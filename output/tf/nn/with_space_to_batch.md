...
more details.</p>
<p>`tf.compat.v1.nn.with_space_to_batch`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.nn.with_space_to_batch(
...
<td>
If padding = "SAME", specifies the shape of the convolution
...
<td>
if `padding` is invalid or the arguments are incompatible.
</td>
</tr><tr>
<td>
`ValueError`
