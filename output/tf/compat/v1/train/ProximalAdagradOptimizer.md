description: Optimizer that implements the Proximal Adagrad algorithm.
...
<a target="_blank" href="/code/stable/tensorflow/python/training/proximal_adagrad.py">View source</a>
