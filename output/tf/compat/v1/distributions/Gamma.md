...
<meta itemprop="name" content="tf.compat.v1.distributions.Gamma" />
...
<a target="_blank" href="/code/stable/tensorflow/python/ops/distributions/gamma.py">View source</a>
...
<code>tf.compat.v1.distributions.Gamma(
...
`rate` is very large. See note in <a href="../../../../tf/random/gamma.md"><code>tf.random.gamma</code></a> docstring.
...
<td>
Floating point tensor, the concentration params of the
