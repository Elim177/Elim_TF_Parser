...
<meta itemprop="name" content="tf.compat.v1.distributions.StudentT" />
...
<a target="_blank" href="/code/stable/tensorflow/python/ops/distributions/student_t.py">View source</a>
...
<code>tf.compat.v1.distributions.StudentT(
...
<td>
Floating-point `Tensor`. The mean(s) of the distribution(s).
</td>
</tr><tr>
<td>
`scale`
...
<td>
Floating-point `Tensor`. The scaling factor(s) for the
