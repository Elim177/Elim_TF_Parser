...
Inherits From: [`Dataset`](../../../../../tf/compat/v1/data/Dataset.md), [`Dataset`](../../../../../tf/data/Dataset.md)

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.compat.v1.data.experimental.CsvDataset(
...
<td>
A <a href="../../../../../tf.md#string"><code>tf.string</code></a> tensor containing one or more filenames.
</td>
</tr><tr>
<td>
`record_defaults`
...
<td>
(Optional.) A <a href="../../../../../tf.md#bool"><code>tf.bool</code></a> scalar indicating whether the CSV file(s)
...
<td>
(Optional.) A <a href="../../../../../tf.md#string"><code>tf.string</code></a> scalar containing the delimiter
...
<td>
(Optional.) A <a href="../../../../../tf.md#bool"><code>tf.bool</code></a> scalar. If `False`, treats double
...
<td>
(Optional.) A <a href="../../../../../tf.md#string"><code>tf.string</code></a> scalar indicating a value that will be
treated as NA/NaN.
</td>
</tr><tr>
<td>
...
representing the number elements to process asynchronously in parallel.
If not specified, elements will be processed sequentially. If the value
<a href="../../../../../tf/data.md#AUTOTUNE"><code>tf.data.AUTOTUNE</code></a> is used, then the number of parallel calls is set
...
specified, the <a href="../../../../../tf/data/Options.md#deterministic"><code>tf.data.Options.deterministic</code></a> option (`True` by
