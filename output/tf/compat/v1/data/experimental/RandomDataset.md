description: A Dataset of pseudorandom values. (deprecated)

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tf.compat.v1.data.experimental.RandomDataset" />
...
<a target="_blank" href="/code/stable/tensorflow/python/data/experimental/ops/random_ops.py">View source</a>
...
<code>tf.compat.v1.data.experimental.RandomDataset(
    seed=None, name=None
)
</code></pre>
