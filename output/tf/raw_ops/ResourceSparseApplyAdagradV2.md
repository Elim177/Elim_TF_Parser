...
more details.</p>
<p>`tf.compat.v1.raw_ops.ResourceSparseApplyAdagradV2`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.raw_ops.ResourceSparseApplyAdagradV2(
    var, accum, lr, epsilon, grad, indices, use_locking=(False),
    update_slots=(True), name=None
)
</code></pre>
