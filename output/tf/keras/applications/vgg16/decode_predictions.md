...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.7.0/keras/applications/vgg16.py#L236-L238">
...
more details.</p>
<p>`tf.compat.v1.keras.applications.vgg16.decode_predictions`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.keras.applications.vgg16.decode_predictions(
    preds, top=5
)
</code></pre>
