...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.7.0/keras/applications/inception_v3.py#L417-L419">
...
more details.</p>
<p>`tf.compat.v1.keras.applications.inception_v3.decode_predictions`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.keras.applications.inception_v3.decode_predictions(
    preds, top=5
)
</code></pre>
