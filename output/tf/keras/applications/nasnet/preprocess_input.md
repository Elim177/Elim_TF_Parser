...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.7.0/keras/applications/nasnet.py#L803-L805">
...
more details.</p>
<p>`tf.compat.v1.keras.applications.nasnet.preprocess_input`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.keras.applications.nasnet.preprocess_input(
    x, data_format=None
)
</code></pre>
