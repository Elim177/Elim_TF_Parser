...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.7.0/keras/applications/inception_resnet_v2.py#L380-L382">
...
more details.</p>
<p>`tf.compat.v1.keras.applications.inception_resnet_v2.preprocess_input`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.keras.applications.inception_resnet_v2.preprocess_input(
    x, data_format=None
)
</code></pre>
