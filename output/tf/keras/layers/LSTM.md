...
<td>
  <a target="_blank" href="https://github.com/keras-team/keras/tree/v2.7.0/keras/layers/recurrent_v2.py#L943-L1276">
...
Inherits From: [`LSTM`](../../../tf/compat/v1/keras/layers/LSTM.md), [`RNN`](../../../tf/keras/layers/RNN.md), [`Layer`](../../../tf/keras/layers/Layer.md), [`Module`](../../../tf/Module.md)
...
<code>tf.keras.layers.LSTM(
    ...
    stateful=(False), time_major=(False), unroll=(False), **kwargs
)
</code></pre>
