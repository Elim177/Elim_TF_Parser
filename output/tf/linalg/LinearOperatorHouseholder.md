...
<meta itemprop="name" content="tf.linalg.LinearOperatorHouseholder" />
...
<a target="_blank" href="/code/stable/tensorflow/python/ops/linalg/linear_operator_householder.py">View source</a>
...
more details.</p>
<p>`tf.compat.v1.linalg.LinearOperatorHouseholder`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.linalg.LinearOperatorHouseholder(
