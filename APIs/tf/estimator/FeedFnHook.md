...
more details.</p>
<p>`tf.compat.v1.estimator.FeedFnHook`, `tf.compat.v1.train.FeedFnHook`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.estimator.FeedFnHook(
    feed_fn
)
</code></pre>
...
<td>
function that takes no arguments and returns `dict` of `Tensor`
to feed.
</td>
</tr>
</table>
