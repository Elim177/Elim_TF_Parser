...
more details.</p>
<p>`tf.compat.v1.estimator.GlobalStepWaiterHook`, `tf.compat.v1.train.GlobalStepWaiterHook`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.estimator.GlobalStepWaiterHook(
    wait_until_step
)
</code></pre>
...
<td>
an `int` shows until which global step should we wait.
</td>
</tr>
</table>
