...
<td>
  <a target="_blank" href="https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/canned/rnn.py#L516-L685">
...
Inherits From: [`RNNEstimator`](../../../tf/estimator/experimental/RNNEstimator.md), [`Estimator`](../../../tf/compat/v1/estimator/Estimator.md)

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.estimator.experimental.RNNClassifier(
    sequence_feature_columns, context_feature_columns=None, units=None,
    cell_type=USE_DEFAULT, rnn_cell_fn=None, return_sequences=(False),
...
<td>
A boolean indicating whether to return the last output
...
<td>
A string with the name of the sequence mask tensor. If
