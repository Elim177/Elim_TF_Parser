...
<code>tf.data.FixedLengthRecordDataset(
...
The <a href="../../tf/data/FixedLengthRecordDataset.md"><code>tf.data.FixedLengthRecordDataset</code></a> reads fixed length records from binary
