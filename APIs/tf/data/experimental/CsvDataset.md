...
<code>tf.data.experimental.CsvDataset(
...
The <a href="../../../tf/data/experimental/CsvDataset.md"><code>tf.data.experimental.CsvDataset</code></a> class provides a minimal CSV Dataset
interface. There is also a richer <a href="../../../tf/data/experimental/make_csv_dataset.md"><code>tf.data.experimental.make_csv_dataset</code></a>
...
<td>
(Optional.) A <a href="../../../tf.md#bool"><code>tf.bool</code></a> scalar. If `False`, treats
...
<td>
(Optional.) A <a href="../../../tf.md#string"><code>tf.string</code></a> scalar indicating a value that will
