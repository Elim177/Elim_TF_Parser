description: Optimizer that implements the proximal gradient descent algorithm.
...
<a target="_blank" href="/code/stable/tensorflow/python/training/proximal_gradient_descent.py">View source</a>
