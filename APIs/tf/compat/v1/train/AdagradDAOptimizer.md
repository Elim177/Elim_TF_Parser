description: Adagrad Dual Averaging algorithm for sparse linear models.
...
<a target="_blank" href="/code/stable/tensorflow/python/training/adagrad_da.py">View source</a>
...
<code>tf.compat.v1.train.AdagradDAOptimizer(
...
<td>
If the `initial_gradient_squared_accumulator_value` is
invalid.
</td>
</tr>
</table>
