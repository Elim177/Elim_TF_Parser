...
[`RaggedBincount(...)`](../../../tf/raw_ops/RaggedBincount.md): Counts the number of occurrences of each value in an integer array.

[`RaggedCountSparseOutput(...)`](../../../tf/raw_ops/RaggedCountSparseOutput.md): Performs sparse-output bin counting for a ragged tensor input.

[`RaggedCross(...)`](../../../tf/raw_ops/RaggedCross.md): Generates a feature cross from a list of tensors, and returns it as a
...
[`ReadVariableXlaSplitND(...)`](../../../tf/raw_ops/ReadVariableXlaSplitND.md): Splits resource variable input tensor across all dimensions.
...
[`RegisterDataset(...)`](../../../tf/raw_ops/RegisterDataset.md): Registers a dataset with the tf.data service.
...
[`ResourceApplyMomentum(...)`](../../../tf/raw_ops/ResourceApplyMomentum.md): Update '*var' according to the momentum scheme.
...
[`ResourceScatterNdMax(...)`](../../../tf/raw_ops/ResourceScatterNdMax.md)

[`ResourceScatterNdMin(...)`](../../../tf/raw_ops/ResourceScatterNdMin.md)
...
[`RetrieveTPUEmbeddingAdagradMomentumParameters(...)`](../../../tf/raw_ops/RetrieveTPUEmbeddingAdagradMomentumParameters.md): Retrieve Adagrad Momentum embedding parameters.
...
[`RetrieveTPUEmbeddingFrequencyEstimatorParameters(...)`](../../../tf/raw_ops/RetrieveTPUEmbeddingFrequencyEstimatorParameters.md): Retrieve frequency estimator embedding parameters.
...
[`RetrieveTPUEmbeddingProximalYogiParameters(...)`](../../../tf/raw_ops/RetrieveTPUEmbeddingProximalYogiParameters.md)
...
[`SaveDataset(...)`](../../../tf/raw_ops/SaveDataset.md)

[`SaveDatasetV2(...)`](../../../tf/raw_ops/SaveDatasetV2.md)
...
[`ScatterNd(...)`](../../../tf/raw_ops/ScatterNd.md): Scatters `updates` into a tensor of shape `shape` according to `indices`.

[`ScatterNdAdd(...)`](../../../tf/raw_ops/ScatterNdAdd.md): Applies sparse addition to individual values or slices in a Variable.

[`ScatterNdMax(...)`](../../../tf/raw_ops/ScatterNdMax.md): Computes element-wise maximum.

[`ScatterNdMin(...)`](../../../tf/raw_ops/ScatterNdMin.md): Computes element-wise minimum.
...
[`ShuffleAndRepeatDatasetV2(...)`](../../../tf/raw_ops/ShuffleAndRepeatDatasetV2.md)
...
[`ShuffleDatasetV3(...)`](../../../tf/raw_ops/ShuffleDatasetV3.md)
...
[`SnapshotDatasetReader(...)`](../../../tf/raw_ops/SnapshotDatasetReader.md)

[`SnapshotDatasetV2(...)`](../../../tf/raw_ops/SnapshotDatasetV2.md): Creates a dataset that will write to / read from a snapshot.

[`SnapshotNestedDatasetReader(...)`](../../../tf/raw_ops/SnapshotNestedDatasetReader.md)
...
[`Softplus(...)`](../../../tf/raw_ops/Softplus.md)
...
[`SparseBincount(...)`](../../../tf/raw_ops/SparseBincount.md): Counts the number of occurrences of each value in an integer array.
...
[`SparseCountSparseOutput(...)`](../../../tf/raw_ops/SparseCountSparseOutput.md): Performs sparse-output bin counting for a sparse tensor input.

[`SparseCross(...)`](../../../tf/raw_ops/SparseCross.md): Generates sparse cross from a list of sparse and dense tensors.

[`SparseCrossHashed(...)`](../../../tf/raw_ops/SparseCrossHashed.md): Generates sparse cross from a list of sparse and dense tensors.

[`SparseCrossV2(...)`](../../../tf/raw_ops/SparseCrossV2.md): Generates sparse cross from a list of sparse and dense tensors.
...
[`SparseSegmentSumGrad(...)`](../../../tf/raw_ops/SparseSegmentSumGrad.md): Computes gradients for SparseSegmentSum.
...
[`StatelessParameterizedTruncatedNormal(...)`](../../../tf/raw_ops/StatelessParameterizedTruncatedNormal.md)
...
[`StatelessRandomGetAlg(...)`](../../../tf/raw_ops/StatelessRandomGetAlg.md): Picks the best counter-based RNG algorithm based on device.

[`StatelessRandomGetKeyCounter(...)`](../../../tf/raw_ops/StatelessRandomGetKeyCounter.md): Scrambles seed into key and counter, using the best algorithm based on device.
...
[`TensorScatterMax(...)`](../../../tf/raw_ops/TensorScatterMax.md)

[`TensorScatterMin(...)`](../../../tf/raw_ops/TensorScatterMin.md)
...
[`UncompressElement(...)`](../../../tf/raw_ops/UncompressElement.md): Uncompresses a compressed dataset element.
...
[`WindowOp(...)`](../../../tf/raw_ops/WindowOp.md)
...
[`XlaConcatND(...)`](../../../tf/raw_ops/XlaConcatND.md): Concats input tensor across all dimensions.

[`XlaSplitND(...)`](../../../tf/raw_ops/XlaSplitND.md): Splits input tensor across all dimensions.
