...
<meta itemprop="name" content="tf.compat.v1.distributions.Exponential" />
...
<a target="_blank" href="/code/stable/tensorflow/python/ops/distributions/exponential.py">View source</a>



Exponential distribution.

Inherits From: [`Gamma`](../../../../tf/compat/v1/distributions/Gamma.md), [`Distribution`](../../../../tf/compat/v1/distributions/Distribution.md)

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.compat.v1.distributions.Exponential(
    rate, validate_args=(False), allow_nan_stats=(True),
    name=&#x27;Exponential&#x27;
)
</code></pre>
...
<td>
Floating point tensor, equivalent to `1 / mean`. Must contain only
positive values.
</td>
</tr><tr>
<td>
