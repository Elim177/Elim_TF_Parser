...
<meta itemprop="name" content="tf.compat.v1.distributions.Multinomial" />
...
<a target="_blank" href="/code/stable/tensorflow/python/ops/distributions/multinomial.py">View source</a>
...
<code>tf.compat.v1.distributions.Multinomial(
    total_count, logits=None, probs=None, validate_args=(False),
