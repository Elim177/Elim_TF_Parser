description: The Laplace distribution with location loc and scale parameters.

<div itemscope itemtype="http://developers.google.com/ReferenceObject">
<meta itemprop="name" content="tf.compat.v1.distributions.Laplace" />
...
<a target="_blank" href="/code/stable/tensorflow/python/ops/distributions/laplace.py">View source</a>
...
<code>tf.compat.v1.distributions.Laplace(
...
<td>
Floating point tensor which characterizes the location (center)
of the distribution.
</td>
</tr><tr>
<td>
...
<td>
Positive floating point tensor which characterizes the spread of
the distribution.
</td>
</tr><tr>
<td>
...
<td>
if `loc` and `scale` are of different dtype.
</td>
</tr>
</table>
