...
<meta itemprop="name" content="tf.compat.v1.mixed_precision.MixedPrecisionLossScaleOptimizer" />
...
<a target="_blank" href="/code/stable/tensorflow/python/training/experimental/loss_scale_optimizer.py">View source</a>
...
more details.</p>
<p>`tf.compat.v1.train.experimental.MixedPrecisionLossScaleOptimizer`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.compat.v1.mixed_precision.MixedPrecisionLossScaleOptimizer(
    opt, loss_scale
)
</code></pre>
...
<td>
A Tensor containing the value to minimize or a callable taking no
...
<td>
If True, try colocating gradients with the
corresponding op.
</td>
</tr><tr>
<td>
