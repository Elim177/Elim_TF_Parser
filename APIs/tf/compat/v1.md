...
<a target="_blank" href="/code/stable/tensorflow/_api/v2/compat/v1/__init__.py">View source</a>
...
[`autograph`](../../tf/compat/v1/autograph.md) module: Conversion of eager-style Python into TensorFlow graph code.
...
[`keras`](../../tf/compat/v1/keras.md) module: Public API for tf.keras namespace.

[`layers`](../../tf/compat/v1/layers.md) module: Public API for tf.keras.__internal__.legacy.layers namespace.
...
[`nn`](../../tf/compat/v1/nn.md) module: Primitive Neural Net (NN) Operations.
...
[`div_no_nan(...)`](../../tf/math/divide_no_nan.md): Computes a safe divide which returns 0 if `y` (denominator) is zero.
