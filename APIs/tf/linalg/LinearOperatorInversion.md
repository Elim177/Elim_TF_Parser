...
<a target="_blank" href="/code/stable/tensorflow/python/ops/linalg/linear_operator_inversion.py">View source</a>
...
more details.</p>
<p>`tf.compat.v1.linalg.LinearOperatorInversion`</p>
</p>
</section>

<pre class="devsite-click-to-copy prettyprint lang-py tfo-signature-link">
<code>tf.linalg.LinearOperatorInversion(
...
<td>
`LinearOperator` object. If `operator.is_non_singular == False`,
