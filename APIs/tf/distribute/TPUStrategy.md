...
<meta itemprop="name" content="tf.distribute.TPUStrategy" />
...
<code>tf.distribute.TPUStrategy(
...
`fit` and `compile` methods available in <a href="../../tf/keras/Model.md"><code>tf.keras.Model</code></a>, then Keras will
...
Then you can run a <a href="../../tf/math/add.md"><code>tf.add</code></a> operation only on logical device 0.
...
<td>
A
<a href="../../tf/distribute/cluster_resolver/TPUClusterResolver.md"><code>tf.distribute.cluster_resolver.TPUClusterResolver</code></a> instance, which
...
<td>
Optional
<a href="../../tf/tpu/experimental/DeviceAssignment.md"><code>tf.tpu.experimental.DeviceAssignment</code></a> to specify the placement of
