...
Inherits From: [`MultiWorkerMirroredStrategy`](../../../tf/distribute/MultiWorkerMirroredStrategy.md), [`Strategy`](../../../tf/distribute/Strategy.md)
...
As a multi-worker strategy, <a href="../../../tf/distribute/MultiWorkerMirroredStrategy.md"><code>tf.distribute.MultiWorkerMirroredStrategy</code></a>
provides the associated <a href="../../../tf/distribute/cluster_resolver/ClusterResolver.md"><code>tf.distribute.cluster_resolver.ClusterResolver</code></a>. If
